    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            vpc: VPC to deploy the Lambda function in.
            vpc_subnets: Subnet selection for Lambda function deployment.
            security_groups: Security groups for Lambda function.
        ...
        if self._vpc:
            function_props["vpc"] = self._vpc
            function_props["vpc_subnets"] = self._vpc_subnets or ec2.SubnetSelection(
                subnet_type=ec2.SubnetType.PRIVATE_WITH_EGRESS,
            )
            if self._security_groups:
                function_props["security_groups"] = self._security_groups

        self.function = lambda_.Function(self, "Function", **function_props)
            ...
            role.add_to_policy(
                iam.PolicyStatement(
                    ...
                    resources=[
                        ...
                        "*",  # Textract resources use wildcard
                    ],
                ),
            )
